  ...
  const struct PolyPoint *opt_b, const struct PolyPoint *opt_c)
{
    ...
    if (tlp->var_8A)
    {
        ...
        if (((eH < 0) ^ eH_overflow) | (eH == 0)) {
            LOGNO("skip due to sum %ld %ld", (s32)tlr->var_44, (s32)tlp->var_78);
            return 0;
        }
        tlr->var_44 = eH;
  ...
  const struct PolyPoint *opt_b, const struct PolyPoint *opt_c)
{
    ...
    ratio_var_34 = (tlp->var_38 << 16) / tlp->var_34;
    {
        ...
        eX = wX + dX;
        if ((eX < 0) ^ eX_overflow) {
            LOGNO("skip due to sum %ld %ld", (s32)wX, (s32)dX);
            return 0;
        }
        if (eX != 0) {
            s32 s32 dS, wS;
  ...
  const struct PolyPoint *opt_b, const struct PolyPoint *opt_c)
{
    ...
    if (opt_a->Y < 0) {
        ...
        LOGNO("height %ld exceeded by opt_a Y %ld", (s32)vec_window_height, (s32)opt_a->Y);
        return 0;
    }
    ...
    if ((dX << 16) / dY <= tlp->var_28) {
        LOGNO("value (%ld << 16) / %ld below min %ld", (s32)dX, (s32)dY, (s32)tlp->var_28);
        return 0;
    }
    tlp->var_2C = (dX << 16) / dY;
  ...
  const struct PolyPoint *opt_b, const struct PolyPoint *opt_c)
{
    ...
    ratio_var_34 = (tlp->var_34 << 16) / tlp->var_38;
    {
        ...
        eX = wXb + dXa;
        if ((eX < 0) ^ eX_overflow) {
            LOGNO("skip due to sum %ld %ld", (s32)wXb, (s32)dXa);
            return 0;
        }
        if (eX != 0) {
            s32 s32 dS, wS;
